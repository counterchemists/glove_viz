...
public class CustomIK : MonoBehaviour {
    ...
    public Vector3 RotationsToMotorAngle()
    {
        Vector3 angle;
        float a1 = Vector3.Angle(Vector3.forward, elbowBone.transform.position - rootBone.transform.forward);
        float a2 = Vector3.Angle(elbowBone.transform.position - rootBone.transform.forward, endBone.transform.position - elbowBone.transform.position);
        float a3 = Vector3.Angle(endBone.transform.position - elbowBone.transform.position, tipBone.transform.position - endBone.transform.position);
        angle = new Vector3(a1, a2, a3);
        return angle;
    }
